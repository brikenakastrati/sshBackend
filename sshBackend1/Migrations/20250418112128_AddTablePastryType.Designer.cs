...
namespace sshBackend1.Migrations
{
    ...
    [Migration("20250418112128_AddTablePastryType")]
    partial class AddTablePastryType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("sshBackend1.Models.GuestStatus", b =>
                {
                    b.Property<int>("GuestStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("GuestStatusId"));

                    b.Property<string>("GuestStatusName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("sshBackend1.Models.Users", b =>
                {
            ...
            modelBuilder.Entity("sshBackend1.Models.Guest", b =>
                {
                    ...
                    b.HasOne("sshBackend1.Models.GuestStatus", "GuestStatus")
                        .WithMany("Guests")
